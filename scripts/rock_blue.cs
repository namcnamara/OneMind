...
public partial class rock_blue : RigidBody3D
{
	...
	public override void _Ready()
	{
		...
		animatedSprite = GetNode<AnimatedSprite3D>("rock_blue_anim");
		collisionShape = GetNode<CollisionShape3D>("rock_blue_collide");
