...
public partial class tree_tall : RigidBody3D
{
	...
	public override void _Ready()
	{
		...
		animatedSprite = GetNode<AnimatedSprite3D>("tree_tall_anim");
		collisionShape = GetNode<CollisionShape3D>("tree_tall_collide");
